...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  // ── Agents ──────────────────────────────────────────────────────────────────
  {
    ...
    trigger: '/agent',
    icon: '🤖',
    description: 'Activate a specialized agent (139+ agents available)',
    detail: 'Browse and activate agents from engineering, design, marketing, testing, strategy, and more. Each agent has deep expertise in its domain.',
    usage: '/agent  |  /agent ai-engineer  |  /agent security-engineer',
    category: 'tools',
  },
  {
    name: 'agents',
    trigger: '/agents',
    icon: '⇶',
    description: 'List all available agents by category',
    detail: 'Shows all 139+ agents organized by division: Engineering, Design, Marketing, Product, Testing, Support, Specialized, Strategy.',
    usage: '/agents  |  /agents engineering  |  /agents testing',
    category: 'tools',
  },
  {
    name: 'orchestrate',
    trigger: '/orchestrate',
    icon: '🎛️',
    description: 'Run multi-agent NEXUS pipeline (Full/Sprint/Micro)',
    detail: 'Activates the Agents Orchestrator to run a complete development pipeline with quality gates, Dev↔QA loops, and parallel execution.',
    usage: '/orchestrate "build a web app" full  |  /orchestrate "add feature" sprint',
    category: 'tools',
  },
  {
    name: 'nexus',
    trigger: '/nexus',
    icon: '🌐',
    description: 'Full NEXUS 7-phase pipeline orchestration',
    detail: 'Run the complete NEXUS pipeline: Discover → Strategize → Scaffold → Build → Harden → Launch → Operate. Enterprise-grade multi-agent coordination.',
    usage: '/nexus "build SaaS product"  |  /nexus "mobile app" sprint',
    category: 'tools',
  },
];
